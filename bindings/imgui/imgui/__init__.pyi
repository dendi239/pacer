...
def image(
    user_texture_id: ImTextureID, image_size: ImVec2, uv0: Optional[ImVec2] = None, uv1: Optional[ImVec2] = None
) -> None:
    """---
    Python bindings defaults:
...
class StyleVar_(enum.Enum):
    ...
    tree_lines_size = enum.auto()  # (= 29)  # float     TreeLinesSize
    # ImGuiStyleVar_TreeLinesRounding,            /* original C++ signature */
    tree_lines_rounding = enum.auto()  # (= 30)  # float     TreeLinesRounding
    # ImGuiStyleVar_ButtonTextAlign,              /* original C++ signature */
    button_text_align = enum.auto()  # (= 31)  # ImVec2    ButtonTextAlign
    # ImGuiStyleVar_SelectableTextAlign,          /* original C++ signature */
    selectable_text_align = enum.auto()  # (= 32)  # ImVec2    SelectableTextAlign
    # ImGuiStyleVar_SeparatorTextBorderSize,      /* original C++ signature */
    separator_text_border_size = enum.auto()  # (= 33)  # float     SeparatorTextBorderSize
    # ImGuiStyleVar_SeparatorTextAlign,           /* original C++ signature */
    separator_text_align = enum.auto()  # (= 34)  # ImVec2    SeparatorTextAlign
    # ImGuiStyleVar_SeparatorTextPadding,         /* original C++ signature */
    separator_text_padding = enum.auto()  # (= 35)  # ImVec2    SeparatorTextPadding
    # ImGuiStyleVar_DockingSeparatorSize,         /* original C++ signature */
    docking_separator_size = enum.auto()  # (= 36)  # float     DockingSeparatorSize
...
class Style:
    ...
    tab_close_button_min_width_selected: float  # -1: always visible. 0.0: visible when hovered. >0.0: visible when hovered if minimum width.
...
class IO:
    ...
    mouse_released_time: np.ndarray  # ndarray[type=double, size=5]  # Time of last released (rarely used! but useful to handle delayed single-click when trying to disambiguate them from double-click).
...
class ListClipper:
    ...
    start_seek_offset_y: float  # [Internal] Account for frozen rows in a table and initial loss of precision in very large windows.
...
class MultiSelectIO:
    ...
    requests: ImVector_SelectionRequest  #  ms:w, app:r     /  ms:w  app:r   // Requests to apply to your selection data.
...
class SelectionBasicStorage:
    ...
    # void*           UserData;    /* original C++ signature */
    user_data: Any  # = None   // User data for use by adapter function        // e.g. selection.UserData = (None*)my_items;
...
class ImFontConfig:
    ...
    glyph_extra_advance_x: float  # 0        // Extra spacing (in pixels) between glyphs. Please contact us if you are using this.
    ...
    rasterizer_density: float  # 1.0     // DPI scale for rasterization, not altering other font metrics: make it easy to swap between e.g. a 100% and a 400% fonts for a zooming display, or handle Retina screen. IMPORTANT: If you change this it is expected that you increase/decrease font scale roughly to the inverse of this, otherwise quality may look lowered.
