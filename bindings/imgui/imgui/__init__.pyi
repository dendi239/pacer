import enum
import sys
from typing import overload, Callable, Tuple, List, Any, Optional
...
def image(
    tex_ref: ImTextureRef, image_size: ImVec2, uv0: Optional[ImVec2] = None, uv1: Optional[ImVec2] = None
) -> None:
    """Python bindings defaults:
...
@overload
def selectable(label: str, selected: bool = False, flags: SelectableFlags = 0, size: Optional[ImVec2] = None) -> bool:
    """Python bindings defaults:
       If size is None, then its default value will be: ImVec2(0, 0)
...
class WindowFlags_(enum.IntEnum):
...
class ChildFlags_(enum.IntEnum):
...
class InputTextFlags_(enum.IntEnum):
...
class TreeNodeFlags_(enum.IntEnum):
...
class PopupFlags_(enum.IntEnum):
...
class SelectableFlags_(enum.IntEnum):
...
class ComboFlags_(enum.IntEnum):
...
class TabBarFlags_(enum.IntEnum):
...
class TabItemFlags_(enum.IntEnum):
...
class FocusedFlags_(enum.IntEnum):
...
class HoveredFlags_(enum.IntEnum):
...
class DockNodeFlags_(enum.IntEnum):
...
class DragDropFlags_(enum.IntEnum):
...
class InputFlags_(enum.IntEnum):
...
class ConfigFlags_(enum.IntEnum):
...
class BackendFlags_(enum.IntEnum):
...
class StyleVar_(enum.IntEnum):
    ...
    tab_min_width_base = enum.auto()  # (= 26)  # float     TabMinWidthBase
    # ImGuiStyleVar_TabMinWidthShrink,            /* original C++ signature */
    tab_min_width_shrink = enum.auto()  # (= 27)  # float     TabMinWidthShrink
    # ImGuiStyleVar_TabBarBorderSize,             /* original C++ signature */
    tab_bar_border_size = enum.auto()  # (= 28)  # float     TabBarBorderSize
    # ImGuiStyleVar_TabBarOverlineSize,           /* original C++ signature */
    tab_bar_overline_size = enum.auto()  # (= 29)  # float     TabBarOverlineSize
    # ImGuiStyleVar_TableAngledHeadersAngle,      /* original C++ signature */
    table_angled_headers_angle = enum.auto()  # (= 30)  # float     TableAngledHeadersAngle
    # ImGuiStyleVar_TableAngledHeadersTextAlign,    /* original C++ signature */
    table_angled_headers_text_align = enum.auto()  # (= 31)  # ImVec2  TableAngledHeadersTextAlign
    # ImGuiStyleVar_TreeLinesSize,                /* original C++ signature */
    tree_lines_size = enum.auto()  # (= 32)  # float     TreeLinesSize
    # ImGuiStyleVar_TreeLinesRounding,            /* original C++ signature */
    tree_lines_rounding = enum.auto()  # (= 33)  # float     TreeLinesRounding
    # ImGuiStyleVar_ButtonTextAlign,              /* original C++ signature */
    button_text_align = enum.auto()  # (= 34)  # ImVec2    ButtonTextAlign
    # ImGuiStyleVar_SelectableTextAlign,          /* original C++ signature */
    selectable_text_align = enum.auto()  # (= 35)  # ImVec2    SelectableTextAlign
    # ImGuiStyleVar_SeparatorTextBorderSize,      /* original C++ signature */
    separator_text_border_size = enum.auto()  # (= 36)  # float     SeparatorTextBorderSize
    # ImGuiStyleVar_SeparatorTextAlign,           /* original C++ signature */
    separator_text_align = enum.auto()  # (= 37)  # ImVec2    SeparatorTextAlign
    # ImGuiStyleVar_SeparatorTextPadding,         /* original C++ signature */
    separator_text_padding = enum.auto()  # (= 38)  # ImVec2    SeparatorTextPadding
    # ImGuiStyleVar_DockingSeparatorSize,         /* original C++ signature */
    docking_separator_size = enum.auto()  # (= 39)  # float     DockingSeparatorSize
    # ImGuiStyleVar_COUNT    /* original C++ signature */
    # }
    count = enum.auto()  # (= 40)

class ButtonFlags_(enum.IntEnum):
...
class ColorEditFlags_(enum.IntEnum):
...
class SliderFlags_(enum.IntEnum):
...
class MouseButton_(enum.IntEnum):
...
class MouseCursor_(enum.IntEnum):
...
class TableFlags_(enum.IntEnum):
...
class TableColumnFlags_(enum.IntEnum):
...
class TableRowFlags_(enum.IntEnum):
...
class TableBgTarget_(enum.IntEnum):
...
class ListClipperFlags_(enum.IntEnum):
...
class MultiSelectFlags_(enum.IntEnum):
...
class ImDrawCmdHeader:
    ...
    def __init__(self, clip_rect: Optional[ImVec4] = None, tex_ref: Optional[ImTextureRef] = None) -> None:
        """Auto-generated default constructor with named params
...
class ImDrawFlags_(enum.IntEnum):
...
class ImDrawListFlags_(enum.IntEnum):
...
class ImDrawList:
    ...
    def add_polyline(self, points: ImVec2, num_points: int, col: ImU32, flags: ImDrawFlags, thickness: float) -> None:
        pass
    # IMGUI_API void  AddConvexPolyFilled(const ImVec2* points, int num_points, ImU32 col);    /* original C++ signature */
    def add_convex_poly_filled(self, points: ImVec2, num_points: int, col: ImU32) -> None:
        pass
...
class ImDrawData:
    ...
    cmd_lists: ImVector_ImDrawList  # Array of ImDrawList* to render. The ImDrawLists are owned by ImGuiContext and only pointed to from here.
    ...
    textures: ImVector_ImTextureData  # List of textures to update. Most of the times the list is shared by all ImDrawData, has only 1 texture and it doesn't need any update. This almost always points to ImGui::GetPlatformIO().Textures[]. May be overridden or set to None if you want to manually update textures.
...
class ImTextureFormat(enum.IntEnum):
...
class ImTextureStatus(enum.IntEnum):
...
class ImTextureData:
    ...
    def destroy_pixels(self) -> None:
        pass
    # void*               GetPixels()                 { IM_ASSERT(Pixels != NULL); return Pixels; }    /* original C++ signature */
    def get_pixels(self) -> Any:
        """(private API)"""
        pass
    # void*               GetPixelsAt(int x, int y)   { IM_ASSERT(Pixels != NULL); return Pixels + (x + y * Width) * BytesPerPixel; }    /* original C++ signature */
    def get_pixels_at(self, x: int, y: int) -> Any:
        """(private API)"""
        pass
...
class ImFontAtlasFlags_(enum.IntEnum):
...
class ImFontAtlas:
    ...
    tex_list: ImVector_ImTextureData  # Texture list (most often TexList.Size == 1). TexData is always == TexList.back(). DO NOT USE DIRECTLY, USE GetDrawData().Textures[]/GetPlatformIO().Textures[] instead!
    ...
    # ImVector<ImDrawListSharedData*> DrawListSharedDatas;    /* original C++ signature */
    draw_list_shared_datas: (
        ImVector_ImDrawListSharedData  # List of users for this atlas. Typically one per Dear ImGui context.
    )
...
class ImFontFlags_(enum.IntEnum):
    """Font flags
...
class ImFont:
    ...
    # ImVector<ImFontConfig*>     Sources;    /* original C++ signature */
    sources: ImVector_ImFontConfig  # 16    // in  // List of sources. Pointers within OwnerAtlas->Sources[]
    # ImWchar                     EllipsisChar;    /* original C++ signature */
    ...
    def get_font_baked(self, font_size: float, density: float = -1.0) -> ImFontBaked:
        ...
        pass
    # IMGUI_API const char*       CalcWordWrapPosition(float size, const char* text, const char* text_end, float wrap_width);    /* original C++ signature */
    def calc_word_wrap_position(self, size: float, text: str, text_end: str, wrap_width: float) -> str:
        pass
    ...
    def render_char(
        ...
        col: ImU32,
        c: ImWchar,
        cpu_fine_clip: Optional[ImVec4] = None,
    ) -> None:
        pass
...
class ViewportFlags_(enum.IntEnum):
...
class PlatformIO:
    ...
    # ImVector<ImTextureData*>        Textures;    /* original C++ signature */
    textures: ImVector_ImTextureData  # List of textures used by Dear ImGui (most often 1) + contents of external texture list is automatically appended into this.

    # Viewports list (the list is updated by calling ImGui::EndFrame or ImGui::Render)
    # (in the future we will attempt to organize this feature to remove the need for a "main viewport")
    # ImVector<ImGuiViewport*>        Viewports;    /* original C++ signature */
    viewports: ImVector_Viewport  # Main viewports, followed by all secondary viewports.
