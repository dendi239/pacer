...
def sandbox():
    ...
    header_files = [
        repository_dir / "3rdparty/imgui/imgui.h",
        # repository_dir / "3rdparty/imgui/imstb_rectpack.h",
        # repository_dir / "3rdparty/imgui/imstb_textedit.h",
        # repository_dir / "3rdparty/imgui/imstb_truetype.h",
    ]

    output_cpp_pydef_file = repository_dir / "bindings/imgui/nanobind_imgui.cpp"

    litgen.write_generated_code_for_files(
        options=options,
        input_cpp_header_files=[str(p) for p in header_files],
        output_cpp_pydef_file=output_cpp_pydef_file,
        output_stub_pyi_file=str(repository_dir / "bindings/imgui/imgui/__init__.pyi"),
    )
